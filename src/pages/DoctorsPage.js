            ...
            <div class="left-section d-flex align-items-center">
              ...
              <ul class="navbar-nav">
                <li class="nav-item active">
                 <Link to='/doctor'><a class="nav-link text-light mx-3"><b>Home</b></a></Link> 
                </li>
              </ul>
            </div>
            ...
            <div class="right-section d-flex align-items-center ml-auto ">
               
               {
                  ...
                  <Link to='/updateprofile'>
                    ...
                    <p className="username mx-2 mt-3">{doctorDetails.username}</p>
                    <button id="logout-btn " className='mx-3' onClick={logoutUser}>Logout</button>
                  </div>
                  ) : (
                    <>
